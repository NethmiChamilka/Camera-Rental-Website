...
<div class="add">
<a href="additems.php"><button class="btn">Add</button></a>
</div>
<?php
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<td><button class="button1"><a href="editCamera.php?edit=' . $row['itemCode'] . '">Edit</a></button></td>';
...
<script>
  function confirmDelete(itemCode) {
    if (confirm("Are you sure?")) {
      window.location.href = 'deleteCamera.php?deleteCode=' + itemCode;
    } else {
